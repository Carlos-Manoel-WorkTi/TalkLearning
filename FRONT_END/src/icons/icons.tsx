...
export const BtnSearch = styled(IoIosSearch)`
  ...
  padding: 5px;
`;
export const BtnMenu = styled(FiAlignLeft)<{ status: string }>`
  font-size: 1.5rem;
  padding: 5px;
  display: none;
...
// Menu
export const BtnClose = styled(AiOutlineClose)<{ status: string }>`
  font-size: 1.5rem;
  padding: 5px;
  color: red;
...
// translate
export const Trasnlate = styled(BsTranslate)`
  font-size: 15px;
  color: #ffffff;
  width: auto;
`;
